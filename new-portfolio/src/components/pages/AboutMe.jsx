		...
		<section className='About fade-in'>
			<div className='About-Div'>
				...
				<p className='About-Paragraph'>
					I'm a passionate Full-Stack Developer who loves creating seamless
					digital experiences. With expertise in both backend systems and
					frontend interfaces, I bring ideas to life through clean code and
					intuitive design..
				</p>
